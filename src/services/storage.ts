...
class IsomorphicStorage implements Storage {
    private static storageAvailable(type: STORAGE_TYPE): boolean {
        let storage;
    ...
    public constructor(type: STORAGE_TYPE) {
...
const isomorphicLocalStorage = new IsomorphicStorage(STORAGE_TYPE.LOCAL_STORAGE);
const isomorphicSessionStorage = new IsomorphicStorage(STORAGE_TYPE.SESSION_STORAGE);

export { isomorphicLocalStorage, isomorphicSessionStorage };
